...
with st.sidebar.expander('Avaliação da compra'):
    avaliação = st.slider('Selecione a avaliação da compra', dados['Avaliação da compra'].min(), dados['Avaliação da compra'].max(),(dados['Avaliação da compra'].min(), dados['Avaliação da compra'].max()))
with st.sidebar.expander('Tipo de pagamento'):
    tipo = st.multiselect('Selecione o tipo de pagamento', dados['Tipo de pagamento'].unique(), dados['Tipo de pagamento'].unique())
...
@avaliação[0] <= `Avaliação da compra` <= @avaliação[1] and \
`Tipo de pagamento` in @tipo and \
