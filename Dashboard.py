...
Quantidade_estados['Quantidade de vendas'] = dados.groupby('Local da compra')['Preço'].transform('count')
...
Quantidade_mensal['Quantidade de Vendas'] = dados.set_index('Data da Compra').groupby(pd.Grouper(freq='M'))['Preço'].count().values
...
fig_quantidade_mensal = px.line(Quantidade_mensal,
                             ...
                             line_dash='Ano',
                             title='Receita mensal')
fig_quantidade_mensal.update_layout(yaxis_title='Quantidade de vendas mensal')
